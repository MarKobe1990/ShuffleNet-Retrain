...
class CamExtractor():
    ...
    """
    def __init__(self, model, selected_module, target_stage_attr):
        self.model = model
        self.target_stage_attr = target_stage_attr
...
class GradCam():
    ...
    def __init__(self, model, selected_module, target_stage_attr):
        ...
        self.model.eval()
        # Define extractor
        self.extractor = CamExtractor(self.model, selected_module, target_stage_attr)
